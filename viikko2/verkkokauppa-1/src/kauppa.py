...
from viitegeneraattori import viitegeneraattori as default_viitegenaraattori
from ostoskori import Ostoskori


class Kauppa:
    def __init__(self, varasto=default_varasto, pankki=default_pankki, viitegeneraattori=default_viitegenaraattori):
